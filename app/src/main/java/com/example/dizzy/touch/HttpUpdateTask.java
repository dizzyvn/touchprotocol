...
public class HttpUpdateTask extends AsyncTask<Integer, Void, String> {
    @SuppressLint("StaticFieldLeak")
    private Activity parentActivity;
    private String uri = null;
    private Map<String, String> featureMap;

    HttpUpdateTask(Activity parentActivity, Map<String, String> featureMap) {
    ...
    protected void onPreExecute() {
        String DEFAULTURL = "http://jachivi.sakura.ne.jp/update.php?";
